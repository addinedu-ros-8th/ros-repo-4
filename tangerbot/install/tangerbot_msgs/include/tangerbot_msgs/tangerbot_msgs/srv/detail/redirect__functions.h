...
// IWYU pragma: private, include "tangerbot_msgs/srv/redirect.h"


#ifndef TANGERBOT_MSGS__SRV__DETAIL__REDIRECT__FUNCTIONS_H_
#define TANGERBOT_MSGS__SRV__DETAIL__REDIRECT__FUNCTIONS_H_
...
/// Initialize srv/Redirect message.
/**
 ...
 * )) before or use
 * tangerbot_msgs__srv__Redirect_Request__create()
...
/// Create srv/Redirect message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tangerbot_msgs__srv__Redirect_Request__init().
...
/// Destroy srv/Redirect message.
/**
 * It calls
 * tangerbot_msgs__srv__Redirect_Request__fini()
...
/// Check for srv/Redirect message equality.
/**
...
/// Initialize array of srv/Redirect messages.
/**
...
/// Finalize array of srv/Redirect messages.
/**
 * It calls
 * tangerbot_msgs__srv__Redirect_Request__fini()
...
/// Create array of srv/Redirect messages.
/**
 * It allocates the memory for the array and calls
 * tangerbot_msgs__srv__Redirect_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Redirect messages.
/**
 * It calls
 * tangerbot_msgs__srv__Redirect_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Redirect message array equality.
/**
...
/// Copy an array of srv/Redirect messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * tangerbot_msgs__srv__Redirect_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_tangerbot_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tangerbot_msgs__srv__Redirect_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tangerbot_msgs
...
/**
 * It calls
 * tangerbot_msgs__srv__Redirect_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tangerbot_msgs
...
/**
 * It allocates the memory for the array and calls
 * tangerbot_msgs__srv__Redirect_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tangerbot_msgs
...
/**
 * It calls
 * tangerbot_msgs__srv__Redirect_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * tangerbot_msgs__srv__Redirect_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_tangerbot_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tangerbot_msgs__srv__Redirect_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tangerbot_msgs
...
/**
 * It calls
 * tangerbot_msgs__srv__Redirect_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tangerbot_msgs
...
/**
 * It allocates the memory for the array and calls
 * tangerbot_msgs__srv__Redirect_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tangerbot_msgs
...
/**
 * It calls
 * tangerbot_msgs__srv__Redirect_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TANGERBOT_MSGS__SRV__DETAIL__REDIRECT__FUNCTIONS_H_
