  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x03, 0xc6, 0xe8, 0x63, 0xca, 0x55, 0xbc, 0xc8,
      0xcc, 0x36, 0x67, 0x98, 0x48, 0xda, 0x53, 0xb9,
      0x5b, 0xe9, 0xb6, 0x7e, 0x0b, 0x6c, 0x01, 0x8d,
      0x9e, 0x30, 0x3d, 0xa9, 0x64, 0xe5, 0xad, 0x49,
    }};
  return &hash;
}
...
static char tangerbot_msgs__msg__RobotPose__TYPE_NAME[] = "tangerbot_msgs/msg/RobotPose";
...
static char tangerbot_msgs__msg__RobotPose__FIELD_NAME__robot_id[] = "robot_id";
static char tangerbot_msgs__msg__RobotPose__FIELD_NAME__pose[] = "pose";

static rosidl_runtime_c__type_description__Field tangerbot_msgs__msg__RobotPose__FIELDS[] = {
  {
    {tangerbot_msgs__msg__RobotPose__FIELD_NAME__robot_id, 8, 8},
    {
  ...
  {
    {tangerbot_msgs__msg__RobotPose__FIELD_NAME__pose, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription tangerbot_msgs__msg__RobotPose__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {tangerbot_msgs__msg__RobotPose__TYPE_NAME, 28, 28},
      {tangerbot_msgs__msg__RobotPose__FIELDS, 2, 2},
    },
    {tangerbot_msgs__msg__RobotPose__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
tangerbot_msgs__msg__RobotPose__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *tangerbot_msgs__msg__RobotPose__get_individual_type_description_source(NULL),
