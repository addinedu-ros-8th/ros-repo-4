...
#ifndef TANGERBOT_MSGS__MSG__DETAIL__ROBOT_STATE__TYPE_SUPPORT_H_
#define TANGERBOT_MSGS__MSG__DETAIL__ROBOT_STATE__TYPE_SUPPORT_H_
...
#endif  // TANGERBOT_MSGS__MSG__DETAIL__ROBOT_STATE__TYPE_SUPPORT_H_
