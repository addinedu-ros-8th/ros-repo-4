...
{
  new (message_memory) tangerbot_msgs::msg::RobotPose(_init);
}

void RobotPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tangerbot_msgs::msg::RobotPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotPose_message_member_array[2] = {
  {
    ...
    offsetof(tangerbot_msgs::msg::RobotPose, robot_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tangerbot_msgs::msg::RobotPose, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotPose_message_members = {
  ...
  2,  // number of fields
  sizeof(tangerbot_msgs::msg::RobotPose),
...
get_message_type_support_handle<tangerbot_msgs::msg::RobotPose>()
{
  return &::tangerbot_msgs::msg::rosidl_typesupport_introspection_cpp::RobotPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tangerbot_msgs, msg, RobotPose)() {
  return &::tangerbot_msgs::msg::rosidl_typesupport_introspection_cpp::RobotPose_message_type_support_handle;
}
