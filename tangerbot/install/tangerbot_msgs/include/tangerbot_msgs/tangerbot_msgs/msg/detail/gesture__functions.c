...
tangerbot_msgs__msg__Gesture__init(tangerbot_msgs__msg__Gesture * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->robot_id)) {
    tangerbot_msgs__msg__Gesture__fini(msg);
    return false;
  }
  // point
...
tangerbot_msgs__msg__Gesture__create(void)
{
  ...
  tangerbot_msgs__msg__Gesture * msg = (tangerbot_msgs__msg__Gesture *)allocator.allocate(sizeof(tangerbot_msgs__msg__Gesture), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tangerbot_msgs__msg__Gesture));
  bool success = tangerbot_msgs__msg__Gesture__init(msg);
  if (!success) {
...
tangerbot_msgs__msg__Gesture__Sequence__init(tangerbot_msgs__msg__Gesture__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tangerbot_msgs__msg__Gesture * data = NULL;

  if (size) {
    data = (tangerbot_msgs__msg__Gesture *)allocator.zero_allocate(size, sizeof(tangerbot_msgs__msg__Gesture), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tangerbot_msgs__msg__Gesture__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tangerbot_msgs__msg__Gesture__fini(&data[i - 1]);
      }
...
tangerbot_msgs__msg__Gesture__Sequence__fini(tangerbot_msgs__msg__Gesture__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tangerbot_msgs__msg__Gesture__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tangerbot_msgs__msg__Gesture__Sequence * array = (tangerbot_msgs__msg__Gesture__Sequence *)allocator.allocate(sizeof(tangerbot_msgs__msg__Gesture__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tangerbot_msgs__msg__Gesture__Sequence__init(array, size);
  if (!success) {
...
tangerbot_msgs__msg__Gesture__Sequence__destroy(tangerbot_msgs__msg__Gesture__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tangerbot_msgs__msg__Gesture__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tangerbot_msgs__msg__Gesture__Sequence__are_equal(const tangerbot_msgs__msg__Gesture__Sequence * lhs, const tangerbot_msgs__msg__Gesture__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tangerbot_msgs__msg__Gesture__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tangerbot_msgs__msg__Gesture__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tangerbot_msgs__msg__Gesture);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tangerbot_msgs__msg__Gesture * data =
      (tangerbot_msgs__msg__Gesture *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tangerbot_msgs__msg__Gesture__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tangerbot_msgs__msg__Gesture__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tangerbot_msgs__msg__Gesture__copy(
